...
//  setTimestamp(index, 데이터) : 시간 데이터를 입력
  ...
  try {
//    Statement 와 달리 Connection 클래스 타입의 객체를 통해서 PreparedStatement 객체 생성 시 매개변수로 sql문을 사용함
