...
<%@page import="bitc.fullstack405.study.dto.Person" %>
...
<div class="container mt-4">
  ...
  <div class="border border-2 rounded-3">
    <ul class="list-group">
      <li class="list-group-item">Integer 객체 : <%=(pInteger3 == null) ? "값 없음" : pInteger3%></li>
      <li class="list-group-item">String 객체 : <%=(pString3 == null) ? "값 없음" : pString3%></li>
      <li class="list-group-item">Person 객체 : <%=(pPerson3 == null) ? "값 없음" : ((Person)pPerson3).getName()%></li>
    </ul>
  </div>
</div>
</body>
