...
<%--    영역표시가 없으면 지정한 변수명을 가지고 있는 가장 낮은 영역의 변수를 출력 --%>
...
<%--  jstl의 remove를 사용하여 지정한 영역의 변수 삭제 --%>
  ...
  <ul class="list-group">
    <li class="list-group-item">scopeVar : ${scopeVar}</li>
    <li class="list-group-item">request.scopeVar : ${requestScope.scopeVar}</li>
    <li class="list-group-item">session.scopeVar : ${sessionScope.scopeVar}</li>
    <li class="list-group-item">application.scopeVar : ${applicationScope.scopeVar}</li>
  </ul>
