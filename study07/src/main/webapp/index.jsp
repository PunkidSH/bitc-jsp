...
<div class="container mt-5">
  <h2 class="text-center mt-5">chap07</h2>

  <ul class="list-group">
    <li class="list-group-item"><a href="chap07/IncludeMain.jsp" target="_blank" class="btn btn-link">액션태그 include</a></li>
    <li class="list-group-item"><a href="chap07/FowardMain.jsp" target="_blank" class="btn btn-link">액션태그 forward</a></li>
  ...
  <h2 class="text-center mt-5">chap08</h2>
